...
{ 
    ...
    { 
        //std::cout<< "tile: " << TS << "\n";
        //std::cout<<"scroll speed " << TheGame::Instance()->getScrollSpeed() << "\n";
        //std::cout<<"game width: " << TheGame::Instance()->getGameWidth() << "\n"; 
    ...
    count++;
    //}while(m_position.getX() > ((m_mapWidth * m_tileSize) - 
    //                TheGame::Instance()->getGameWidth()) - m_tileSize);
    //std::cout <<m_position.getX() << "\n";
    //std::cout << ((m_mapWidth * m_tileSize) - 
    //                TheGame::Instance()->getGameWidth()) - m_tileSize << "\n";
}
